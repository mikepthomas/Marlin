 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD         // BLTouch + Menus
  ...
  #define SHOW_BOOTSCREEN                 // Show the Marlin bootscreen on startup. ** ENABLE FOR PRODUCTION **
    ...
    #define BOOTSCREEN_TIMEOUT 3500       // (ms) Total Duration to display the boot screen(s)
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY           // BTT UPS V2.0
    ...
    #define POWER_LOSS_PIN            P1_25 // BTT UPS V2.0 Pin to detect power-loss. Set to -1 to disable default pin on boards without module, or comment to use board default.
    ...
    #define BACKUP_POWER_SUPPLY             // BTT UPS V2.0 Backup power / UPS to move the steppers on power-loss
      ...
      #define POWER_LOSS_RETRACT_LEN     10 // BTT UPS V2.0 (mm) Length of filament to retract on fail
    #endif
 ...
 */
#define M114_DETAIL           // BTT SFS V1.0 + BTT TFT24 V1.1 Use 'M114 D' for details to check planner calculations
