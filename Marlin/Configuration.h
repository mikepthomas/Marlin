...
#define STRING_CONFIG_H_AUTHOR "(Mike Thomas, Anet A8 SKR 1.4)" // Who made the changes.
...
#define SHOW_CUSTOM_BOOTSCREEN            // SKR 1.4

// Show the bitmap in Marlin/_Statusscreen.h on the status screen.
#define CUSTOM_STATUS_SCREEN_IMAGE        // Anet A8

// @section machine

// Choose the name from boards.h that matches your setup
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V1_4  // SKR 1.4
#endif
 ...
 */
#define BAUDRATE 115200       // Anet A8 + BTT TFT24 V1.1 + SKR 1.4
 ...
 */
#define X_DRIVER_TYPE  TMC2209    // BTT TMC2209 V1.2
#define Y_DRIVER_TYPE  TMC2209    // BTT TMC2209 V1.2
#define Z_DRIVER_TYPE  TMC2209    // BTT TMC2209 V1.2
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2209    // BTT TMC2209 V1.2
...
#define E0_DRIVER_TYPE TMC2209    // BTT TMC2209 V1.2
 ...
 */
#define PSU_CONTROL                 // BTT Relay V1.2
#define PSU_NAME "Power Supply"     // BTT Relay V1.2

#if ENABLED(PSU_CONTROL)
  //#define MKS_PWC                 // Using the MKS PWC add-on
  //#define PS_OFF_CONFIRM          // Confirm dialog when power off
  #define PS_OFF_SOUND              // Beep 1s when power off
  #define PSU_ACTIVE_STATE HIGH     // BTT Relay V1.2 Set 'LOW' for ATX, 'HIGH' for X-Box
 ...
 */
#define TEMP_SENSOR_0 11          // AFUNTA Heater
...
#define TEMP_SENSOR_BED 5         // Anet A8
...
// Resistor values when using MAX31865 sensors (-5) on TEMP_SENSOR_0 / 1
  ...
  #define TEMP_RESIDENCY_TIME          6  // Anet A8 (seconds) Time to wait for hotend to "settle" in M109
  #define TEMP_WINDOW                  1  // (°C) Temperature proximity for the "temperature reached" timer
  #define TEMP_HYSTERESIS              3  // (°C) Temperature proximity considered "close enough" to the target
#endif

#if TEMP_SENSOR_BED
  #define TEMP_BED_RESIDENCY_TIME      6  // Anet A8 (seconds) Time to wait for bed to "settle" in M190
...
#define BED_MAXTEMP      130  // Anet A8
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 15 // Anet A8 If the temperature difference between the target temperature and the actual temperature
                                  // is more than PID_FUNCTIONAL_RANGE then the PID will be shut off and the heater will be set to min/max.

  #define PID_EDIT_MENU           // Menus Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)
  #define PID_AUTOTUNE_MENU       // Menus Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)
#endif
...
#define EXTRUDE_MINTEMP 160  // Anet A8 160 guards against false tripping when the extruder fan kicks on.
...
#define Y_MIN_ENDSTOP_INVERTING true  // Anet A8 Set to true to invert the logic of the endstop.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 105.35 }   // Anet A8 + Tune E-Steps
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 8, 50 }         // Anet A8
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 100, 10000 }  // Anet A8
 ...
 */
#define DEFAULT_ACCELERATION           500    // Anet A8 + Tuning X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  1000    // Anet A8 E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   1000    // Anet A8 X, Y, Z acceleration for travel (non printing) moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -22, -36, -2.58 }  // BLTouch
...
#define XY_PROBE_FEEDRATE (133*60)                  // BLTouch

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (10*60)               // BLTouch
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    5 // BLTouch (mm) Z Clearance for Deploy/Stow
#define Z_CLEARANCE_BETWEEN_PROBES  4 // BLTouch (mm) Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     4 // BLTouch (mm) Z Clearance between multiple probes
...
#define Z_MIN_PROBE_REPEATABILITY_TEST        // BTT TFT24 V1.1
...
#define INVERT_X_DIR true         // LDO Motors
#define INVERT_Y_DIR true         // LDO Motors
#define INVERT_Z_DIR true         // Anet A8
...
#define X_BED_SIZE 220            // Anet A8
#define Y_BED_SIZE 220            // Anet A8

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -33             // Anet A8
#define Y_MIN_POS -10             // Anet A8
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 200             // BTT TFT24 V1.1
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  #define SOFT_ENDSTOPS_MENU_ITEM    // Menus Enable/Disable software endstops from the LCD
#endif
 ...
 */
#define FILAMENT_RUNOUT_SENSOR            // BTT SFS V1.0
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 200 // BTT SFS V1.0

  #ifdef FILAMENT_RUNOUT_DISTANCE_MM
    // Enable this option to use an encoder disc that toggles the runout pin
    // as the filament moves. (Be sure to set FILAMENT_RUNOUT_DISTANCE_MM
    // large enough to avoid false positives.)
    #define FILAMENT_MOTION_SENSOR        // BTT SFS V1.0
  #endif
#endif
...
#define AUTO_BED_LEVELING_UBL         // BLTouch
...
#define ENABLE_LEVELING_AFTER_G28     // BLTouch

/**
 * Auto-leveling needs preheating
 */
#define PREHEAT_BEFORE_LEVELING       // BLTouch
...
#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION             // BTT TFT24 V1.1
  ...
  #define MESH_EDIT_GFX_OVERLAY     // BLTouch Display a graphics overlay while editing the mesh

  #define MESH_INSET 10             // BLTouch Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X 10      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X

  #define UBL_HILBERT_CURVE         // BLTouch Use Hilbert distribution for less travel when probing multiple points
  ...
  #define UBL_MESH_WIZARD           // BLTouch Run several commands in a row to get a complete mesh
...
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (10*60) }  // Anet A8 + BLTouch
 ...
 */
#define EEPROM_SETTINGS       // Anet A8 + BTT EEPROM V1.0 + SKR 1.4 Persistent storage with M500 and M501
 ...
 */
#define NOZZLE_PARK_FEATURE             // BTT SFS V1.0 + BTT TFT24 V1.1
 ...
 */
#define SDSUPPORT   // ANET A8 + BTT TFT24 V1.1 + BTT UPS V2.0 + SKR 1.4
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU   // Menus
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER   // BTT SFS V1.0 + BTT TFT24 V1.1
...
#define NEOPIXEL_LED                      // NeoPixels
#if ENABLED(NEOPIXEL_LED)
  #define NEOPIXEL_TYPE          NEO_GRB  // NeoPixels NEO_GRBW, NEO_RGBW, NEO_GRB, NEO_RBG, etc.
                                          // See https://github.com/adafruit/Adafruit_NeoPixel/blob/master/Adafruit_NeoPixel.h
  //#define NEOPIXEL_PIN                4 // LED driving pin
  //#define NEOPIXEL2_TYPE  NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN               5
  #define NEOPIXEL_PIXELS              20 // NeoPixels Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
  #define NEOPIXEL_IS_SEQUENTIAL          // Sequential display for temperature change - LED by LED. Disable to change all LEDs at once.
  #define NEOPIXEL_BRIGHTNESS         255 // NeoPixels Initial brightness (0-255)
  #define NEOPIXEL_STARTUP_TEST           // NeoPixels Cycle through colors at startup
