...
#define STRING_CONFIG_H_AUTHOR "(Mike Thomas, Anet A8 SKR 1.4)" // Original author or contributor.
...
#define BED_MAXTEMP      110  // Anet A8
...
#define PIDTEMPBED        // Anet A8
  ...
  // ANET A8 original Bed with self adhesive Magnet, Spring Steel PEI Sheet  and foil insulation at 70 Degree Celsius
  // (measured with PID Autotune menu)
...
#define Y_MIN_ENDSTOP_HIT_STATE LOW        // Anet A8
